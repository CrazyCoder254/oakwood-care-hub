  ...
  return (
    <footer className="bg-primary text-primary-foreground mt-24">
      <div className="container mx-auto px-4 py-14 grid md:grid-cols-4 gap-10">
        ...
        <div>
          <h4 className="text-primary-foreground font-display text-base mb-3">Explore</h4>
          <ul className="space-y-2 text-sm text-primary-foreground/80">
            ...
            <li><Link to="/team" className="hover:text-primary-foreground">Our Team</Link></li>
            <li><Link to="/courses" className="hover:text-primary-foreground">Training Institute</Link></li>
            <li><Link to="/insurance" className="hover:text-primary-foreground">Insurance Partners</Link></li>
          </ul>
        </div>
        <div>
          <h4 className="text-primary-foreground font-display text-base mb-3">Contact</h4>
          <ul className="space-y-2 text-sm text-primary-foreground/80">
            <li className="flex gap-2"><Phone className="h-4 w-4 text-gold mt-0.5" /> +254 705 185 297</li>
        ...
        <div>
          <h4 className="text-primary-foreground font-display text-base mb-3">Hours</h4>
          <ul className="space-y-2 text-sm text-primary-foreground/80">
